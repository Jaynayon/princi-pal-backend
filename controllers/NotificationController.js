...
async function patchNotification(req, res, next) {
...
async function deleteAllNotificationByUser(req, res, next) {
...
async function getNotification(req, res, next) {
    ...
    try {
        notif = await Notifications.findById(notifId)
        if (notif == null)
...
async function getAssociation(req, res, next) {
    const assocId = req.params.assoc_id || req.body.assoc_id
    if (!assocId) {
        return next()
    }
